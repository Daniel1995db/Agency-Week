...
Item.create ([
	{item: "Chicken Kabob", price: 9, starting_range: 4, ending_range: 6, description: "Char-grilled antibiotic-free chicken breast.", menu_item_id: 1},
	{item: "Rice Plate", price: 10, starting_range: 5, ending_range: 7, description: "Non GMO basmati and wild rice blend.", menu_item_id: 1},
	{item: "Chocolate Chip Cookies", price: 4, starting_range: 2, ending_range: 3, description: "House-baked chocolate chip cookies.", menu_item_id: 1},
	{item: "Juice", price: 3, starting_range: 1, ending_range: 2, description: "Any size fountain juice.", menu_item_id: 1},
	{item: "Tzatziki Sampler", price: 7, starting_range: 4, ending_range: 6, description: "All three tzatziki spreads served with fresh baked pita.", menu_item_id: 2},
	{item: "Greek Salad", price: 9, starting_range: 5, ending_range: 7, description: "Vine ripened tomatoes, red onions, green peppers, cucumbers and kalamata olives. tossed lightly with extra virgin olive oil, kalamata vinegar and garnished with authentic greek feta cheese.", menu_item_id: 2},
	{item: "Frozen Grk Ygrt", price: 6, starting_range: 3, ending_range: 5, description: "Imported from greece. Toppings: granola, honey, walnuts, flax seeds, almonds, strawberries, blueberries, blackberries, mango, pineapple, cranberries, figs, fig preserves, black cherry preserves, rose petal preserves, sweet cherry preserves.", menu_item_id: 2},
	{item: "Sparkling Water", price: 3, starting_range: 1, ending_range: 2, description: "Bottled sparkling water.", menu_item_id: 2}
])
