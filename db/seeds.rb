...
Restaurant.create([
	{cname: "Roti Modern Mediterranean", address: "100 Maiden Ln, New York, NY, United States", number: "(646) 494-3359", image: open("https://media.timeout.com/images/100905081/1024/576/image.jpg"), menu_item_id: 1, email: "roti@gmail.com", password: "password"},
	{cname: "GRK Fresh Greek", address: "111 Fulton St, New York, NY, United States", number: "(212) 385-2010", image: open("https://media-cdn.tripadvisor.com/media/photo-s/04/5e/3a/c9/street-view.jpg"), menu_item_id: 2, email: "grk@gmail.com", password: "password"},
	{cname: "Palm Restaurant", address: "206 West St, New York, NY, United States", number: "(646) 395-6393", image: open("https://upload.wikimedia.org/wikipedia/en/thumb/d/dd/The_Palm_Restaurant.svg/1024px-The_Palm_Restaurant.svg.png"), menu_item_id: 3, email: "palm@gmail.com", password: "password"}
])
...
Item.create ([
	...
	{item: "Fried Calamari", price: 10, starting_range: 5, ending_range: 7, description: "Char-grilled antibiotic-free calamari.", menu_item_id: 3, category: 0},
	{item: "Steak and Potatoes", price: 25, starting_range: 10, ending_range: 20, description: "Sirloin steak cooked at your preference with seasoned potatoes.", menu_item_id: 3, category: 1},
	{item: "Chocolate Cake", price: 7, starting_range: 3, ending_range: 5, description: "House-baked molten lava chocolate cake.", menu_item_id: 3, category: 2},
	{item: "Soda", price: 3, starting_range: 1, ending_range: 2, description: "Any size fountain soda.", menu_item_id: 3, category: 3}
])

Discount.create ([
	{time_frame: 45, description: "All kabobs and falafels: buy one get one free", restaurant_id: 1},
	{time_frame: 30, description: "All salads and yogurt: half price", restaurant_id: 2},
