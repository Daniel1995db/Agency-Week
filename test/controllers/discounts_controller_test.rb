...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { description: @discount.description, restaurant_id: @discount.restaurant_id, time_frame: @discount.time_frame } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { description: @discount.description, restaurant_id: @discount.restaurant_id, time_frame: @discount.time_frame } }
